function result = poissonBlend(im_s, mask_s, im_background)
        ...
        for y = 1:mask_h
            if(mask_s(y+y_off, x+x_off) == 1)  %Check if point is inside the mask
                ...
                if(x == 1 || mask_s(y+y_off, x+x_off-1) == 0)
                    ...
                    temp = im2var(y,x-1);
                    A(e, temp)= -1;
                    b(e) = b(e) - s(y+y_off, x+x_off-1, i) + s(y+y_off, x+x_off, i);
                end
                ...
                if(y == 1 || mask_s(y+y_off-1, x+x_off) == 0)
                    ...
                    temp = im2var(y-1,x);
                    A(e, temp) = -1;
                    b(e) = b(e) - s(y+y_off-1, x+x_off, i) + s(y+y_off, x+x_off, i);
                end
